...
class GTKPainter extends SynthPainter {
    ...
    private final static com.sun.java.swing.plaf.gtk.GTKEngine ENGINE = com.sun.java.swing.plaf.gtk.GTKEngine.INSTANCE;
    ...
    public void paintToolBarBackground(SynthContext context,
        ...
        int gtkState = com.sun.java.swing.plaf.gtk.GTKLookAndFeel.synthStateToGTKState(id, state);
    ...
    public void paintRadioButtonBackground(SynthContext context,
                                     ...
                                     int w, int h) {
        Region id = context.getRegion();
        int gtkState = com.sun.java.swing.plaf.gtk.GTKLookAndFeel.synthStateToGTKState(
    ...
    public void paintRadioButtonMenuItemBackground(SynthContext context,
        ...
        if (gtkState == SynthConstants.MOUSE_OVER) {
            synchronized (UNIXToolkit.GTK_LOCK) {
                if (! ENGINE.paintCachedImage(g, x, y, w, h, id)) {
                    ShadowType shadow = (com.sun.java.swing.plaf.gtk.GTKLookAndFeel.is2_2() ?
    ...
    public void paintInternalFrameBorder(SynthContext context,
                                      Graphics g, int x, int y,
                                      int w, int h) {
        com.sun.java.swing.plaf.gtk.Metacity.INSTANCE.paintFrameBorder(context, g, x, y, w, h);
    }
    ...
    public void paintButtonBackground(SynthContext context, Graphics g,
        ...
        if (name != null && name.startsWith("InternalFrameTitlePane.")) {
            com.sun.java.swing.plaf.gtk.Metacity.INSTANCE.paintButtonBackground(context, g, x, y, w, h);
    ...
    private void paintButtonBackgroundImpl(SynthContext context, Graphics g,
        ...
        synchronized (UNIXToolkit.GTK_LOCK) {
            ...
            com.sun.java.swing.plaf.gtk.GTKStyle style = (com.sun.java.swing.plaf.gtk.GTKStyle)context.getStyle();
            if (defaultCapable && !toolButton) {
                Insets defaultInsets = style.getClassSpecificInsetsValue(
                        context, "default-border",
                        com.sun.java.swing.plaf.gtk.GTKStyle.BUTTON_DEFAULT_BORDER_INSETS);
    ...
    public void paintListBackground(SynthContext context, Graphics g,
                                    int x, int y, int w, int h) {
        // Does not call into ENGINE for better performance
        fillArea(context, g, x, y, w, h, com.sun.java.swing.plaf.gtk.GTKColorType.TEXT_BACKGROUND);
    }
    ...
    public void paintPopupMenuBackground(SynthContext context, Graphics g,
        ...
        synchronized (UNIXToolkit.GTK_LOCK) {
            ...
            ENGINE.paintBackground(g, context, id, gtkState,
                    style.getGTKColor(context, gtkState, com.sun.java.swing.plaf.gtk.GTKColorType.BACKGROUND),
    ...
    public void paintTabbedPaneContentBackground(SynthContext context,
        ...
        PositionType placement = com.sun.java.swing.plaf.gtk.GTKLookAndFeel.SwingOrientationConstantToGTK(
    ...
    public void paintRootPaneBackground(SynthContext context, Graphics g,
                                        int x, int y, int w, int h) {
        // Does not call into ENGINE for better performance
        fillArea(context, g, x, y, w, h, com.sun.java.swing.plaf.gtk.GTKColorType.BACKGROUND);
    }
    ...
    public void paintTreeExpandedIcon(SynthContext context,
        ...
        ENGINE.paintExpander(g, context, Region.TREE,
                com.sun.java.swing.plaf.gtk.GTKLookAndFeel.synthStateToGTKState(context.getRegion(), state),
    ...
    public void paintCheckBoxIcon(SynthContext context,
        ...
        int size = style.getClassSpecificIntValue(context,
                        "indicator-size", com.sun.java.swing.plaf.gtk.GTKIconFactory.DEFAULT_ICON_SIZE);
        int offset = style.getClassSpecificIntValue(context,
                        "indicator-spacing", com.sun.java.swing.plaf.gtk.GTKIconFactory.DEFAULT_ICON_SPACING);
    ...
    public void paintCheckBoxMenuItemCheckIcon(SynthContext context,
        ...
        int size = style.getClassSpecificIntValue(context,"indicator-size",
                com.sun.java.swing.plaf.gtk.GTKIconFactory.DEFAULT_TOGGLE_MENU_ITEM_SIZE);

        ENGINE.paintCheck(g, context, Region.CHECK_BOX_MENU_ITEM, "check",
                x + com.sun.java.swing.plaf.gtk.GTKIconFactory.CHECK_ICON_EXTRA_INSET,
                y + com.sun.java.swing.plaf.gtk.GTKIconFactory.CHECK_ICON_EXTRA_INSET,
                size, size);
    }
    ...
    private void fillArea(SynthContext context, Graphics g,
        ...
        if (context.getComponent().isOpaque()) {
            Region id = context.getRegion();
            int gtkState = com.sun.java.swing.plaf.gtk.GTKLookAndFeel.synthStateToGTKState(id,
    ...
    static class TitledBorder extends AbstractBorder implements UIResource {
        ...
        private SynthStyle getStyle(JComponent c) {
            return SynthLookAndFeel.getStyle(c, com.sun.java.swing.plaf.gtk.GTKEngine.CustomRegion.TITLED_BORDER);
        }

        private SynthContext getContext(JComponent c) {
            int state = SynthConstants.DEFAULT;
            return new SynthContext(c, com.sun.java.swing.plaf.gtk.GTKEngine.CustomRegion.TITLED_BORDER,
                                    getStyle(c), state);
        }
    }
}
